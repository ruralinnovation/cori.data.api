...
import { fetchAuthSession, signInWithRedirect, AuthError } from 'aws-amplify/auth';
            ...
            if (!!amplifyContext
                ...
                await (fetchAuthSession()
                    ...
                    if (signInAttemptCount < 1) {
                        ...
                        if (!(sess === null && sess.hasOwnProperty("tokens") && sess["tokens"].hasOwnProperty("idToken"))) {
...
`;
    ...
    return (React.createElement("div", { className: "app-with-authenticator" }, props.children));
}
