...
import { strideForType, DataType } from './type.js';
import { Data } from './data.js';
import { computeChunkOffsets, isChunkedValid, computeChunkNullable, computeChunkNullCounts, sliceChunks, wrapChunkedCall1, wrapChunkedCall2, wrapChunkedIndexOf } from './util/chunk.js';
import { instance as instance$1 } from './visitor/get.js';
import { instance as instance$2 } from './visitor/set.js';
import { instance as instance$3 } from './visitor/indexof.js';
import { instance } from './visitor/iterator.js';
...
Vector[_a] = ((proto) => {
    ...
    for (const typeId of typeIds) {
        const get = instance$1.getVisitFnByTypeId(typeId);
        const set = instance$2.getVisitFnByTypeId(typeId);
        const indexOf = instance$3.getVisitFnByTypeId(typeId);
        visitorsByTypeId[typeId] = { get, set, indexOf };
        vectorPrototypesByTypeId[typeId] = Object.create(proto, {
            ['isValid']: { value: wrapChunkedCall1(isChunkedValid) },
            ['get']: { value: wrapChunkedCall1(instance$1.getVisitFnByTypeId(typeId)) },
            ['set']: { value: wrapChunkedCall2(instance$2.getVisitFnByTypeId(typeId)) },
