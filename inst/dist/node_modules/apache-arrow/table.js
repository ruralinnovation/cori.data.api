...
import { computeChunkOffsets, computeChunkNullCounts, sliceChunks, wrapChunkedCall1, wrapChunkedCall2, wrapChunkedIndexOf, isChunkedValid } from './util/chunk.js';
...
class Table {
    ...
    [Symbol.iterator]() {
        if (this.batches.length > 0) {
            return instance.visit(new Vector(this.data));
        }
...
Table[_a] = ((proto) => {
    ...
    proto['get'] = wrapChunkedCall1(instance$1.getVisitFn(Type.Struct));
    proto['set'] = wrapChunkedCall2(instance$2.getVisitFn(Type.Struct));
